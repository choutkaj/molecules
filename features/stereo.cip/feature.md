...
exocyclic axis. PL-REX validation uses externally supplied ligand SDF packs to
...
the conservative exocyclic Molfile atropisomeric wedge subset, coordinate-only axis
