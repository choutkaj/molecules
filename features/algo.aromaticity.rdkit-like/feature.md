...
- Caches per-ring donor analyses in the top-level perception pass so ring aromaticity and adjacent protection decisions share the same classified donor state.
